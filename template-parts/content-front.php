...
<section id="about">
	...
	if ( $query_about->have_posts() ) {
		...
		while ( $query_about->have_posts() ) {
			...
			<div class="col-sm-10 col-md-9 col-lg-9 section-content">
			...
			<div class="col-lg-12 col-md-12 section-content">
				...
				if($query_facilities_2->have_posts()){
					while($query_facilities_2->have_posts()){
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 facilities-item" <?php if(has_post_thumbnail()): ?>style="background-image: url('<?php the_post_thumbnail_url('full'); ?>')" <?php endif; ?>>
...
<section id="packages">
	...
	<div id="packages-desktop" class="col-lg-10 col-md-12 hidden-xs hidden-sm">
		<div class="row">
	...
	<div id="packages-mobile" class="col-sm-8 hidden-md hidden-lg">
		<div class="row">
		<?php if($query_packages->have_posts()){
			while($query_packages->have_posts()){
			$query_packages->the_post(); ?>
